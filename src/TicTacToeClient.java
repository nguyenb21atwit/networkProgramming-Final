...
public class TicTacToeClient
    ...
    public static void main( String[] args )
        ...
        // Try to implement it so that I can scan a few ports or IP addresses -
        // Brandan
        // We also need to make it so that it can take input from server and output
        // to
        // console -Brandan
    ...
    public TicTacToeClient( String ipAdd, int portNum )
        ...
        try
            ...
            this.socket = new Socket( ipAdd, portNum ) ;
            // SendStringOverJava -
            ...
            while ( !this.socket.isClosed() )
                ...
                move = inputStream.read() ;
                

                updateBoard( move, 1, gameBoard ) ; // prints the server's move to client's console
                ...
                updateBoard( outputInt, 2, gameBoard ) ; // prints the client's move
                                                         // onto the client console
                ...
                System.out.print( "Send to Server a Number (1-9): " ) ;
                outputInt = clientScanner.nextInt() ;

                updateBoard( outputInt, 2, gameBoard ) ;
